    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-bg-cream">
      ...
      >
        ...
        <div className="text-center flex flex-col items-center gap-2">
          <Link
            href="/"
            className="flex items-center gap-2 font-poppins font-bold text-2xl text-primary"
          >
          ...
          <h2 className="font-poppins font-extrabold text-2xl text-secondary mt-2">
            Create Account
          </h2>
          <p className="text-xs text-text-brown/65">
            Join PantryPilot today and discover smart cooking.
          </p>
        </div>
              ...
              <input
                ...
                className={`w-full rounded-xl border ${
                  errors.name
                    ...
                    : "border-neutral-300 focus:ring-primary/50"
        ...
        <div className="relative flex py-1 items-center">
          ...
          <span className="flex-shrink mx-4 text-neutral-400 text-xs uppercase font-medium">
            Or continue with
          </span>
          <div className="flex-grow border-t border-neutral-200"></div>
        </div>
